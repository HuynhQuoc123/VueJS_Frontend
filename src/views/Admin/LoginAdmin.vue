                ...
                <div class="col-md-6 right">
                    <form @submit.prevent="handle()" class="input-box">
                        ...
                        <div class="input-field">
                            <input v-model="user.email" type="email" class="input" id="email" required autocomplete="off">
                            <label for="email">Email</label>
                        </div>
                        <div class="input-field">
                            <input v-model="user.password" type="password"  class="input" id="password" required>
                        ...
                        <div class="signin">
                            <span>(Đăng nhập dành cho nhân viên)
                            </span>
                        </div>
