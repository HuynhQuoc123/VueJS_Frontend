                ...
                <div class="col-md-6 right">
                    <form @submit.prevent="handle()" class="input-box">
                        ...
                        <div class="input-field">
                            <input type="text" v-model="user.name" class="input" id="name" required autocomplete="off">
                        ...
                        <div class="input-field">
                            <input type="text" v-model="user.phone" class="input" id="phone" required autocomplete="off">
                        ...
                        <div class="input-field">
                            <input type="password" v-model="user.c_password" class="input" id="c_password" required>
